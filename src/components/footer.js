        ...
        <div className="bg-gray-100">
          <div className="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center">
            <div className="p-5 w-48 ">
              ...
              <Link className="my-3 block" to="/">Team <span className="text-teal-600 text-xs p-1" /></Link>
            </div>
            <div className="p-5 w-48 ">
                <div className="text-xs uppercase text-gray-500 font-medium">Product</div>
                <Link className="my-3 block" to="/exclusive-course">Exclusive Course <span className="text-teal-600 text-xs p-1" /></Link>
            </div>
            <div className="p-5 w-48 ">
                <div className="text-xs uppercase text-gray-500 font-medium">Contact us</div>
                <Link className="my-3 block" to="/contact">info@fujisuzuki.com <span className="text-teal-600 text-xs p-1" /></Link> 
            </div>
          </div>
        </div>
      ...
      md:flex-row max-w-6xl">
            ...
            <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
              <a href="/#" className="w-6 mx-1">
                <svg className="fill-current cursor-pointer text-gray-500 hover:text-gray-400" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" style={{fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 2}}>
